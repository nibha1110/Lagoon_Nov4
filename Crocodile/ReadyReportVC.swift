...
//        let dateForm: NSDateFormatter = NSDateFormatter()
    ...
    func setChart(dataPoints: [String], values: [Double]) {
        HelperClass.setBarChartHelper(dataPoints, valuesss: values, barcart: self.barChartView, monthssstemp: monthstemp, labelMessage: "Ready Report", compareMsg: "NO DATA", nodataStr: "No Data For Related Period.")
