...
public class PieChartView: PieRadarChartViewBase
{
    ...
    ///
    /// **default**: `0.5`
//    private var _holeRadiusPercent = CGFloat(0.5) nibha changed this statement
        private var _holeRadiusPercent = CGFloat(0.0)
//    private var _transparentCircleColor: NSUIColor? = NSUIColor(white: 1.0, alpha: 105.0/255.0) nibha changed this statement
    private var _transparentCircleColor: NSUIColor? = NSUIColor(white: 1.0, alpha: 0)
